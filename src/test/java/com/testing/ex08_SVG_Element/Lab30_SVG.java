package com.testing.ex08_SVG_Element;
...
import static com.testing.ex07_WaitHelper.WaitHelpers.checkVisibility;
import static com.testing.ex07_WaitHelper.WaitHelpers.waitJVM;

public class Lab30_SVG {

    EdgeDriver driver;

    //div[@class='amcharts-chart-div']//*[name()='svg']//*[name()='g']//*[name()='g' and contains(@transform,'translate(')]//*[name()='g' and contains(@transform,'translate(')]//*[name()='path']
    @BeforeTest
